...
public class ANS_CharacterVisuals_Attack_RHorSwing_0 : ANS_AnimatorState
{
    public readonly ANR_AnimationRange HitBoxActive;

    public ANS_CharacterVisuals_Attack_RHorSwing_0(Animator animator, int animatorLayer)
        : base(animator, nameof(ANS_CharacterVisuals_Attack_RHorSwing_0), animatorLayer, 40)
    {
        HitBoxActive = new(
