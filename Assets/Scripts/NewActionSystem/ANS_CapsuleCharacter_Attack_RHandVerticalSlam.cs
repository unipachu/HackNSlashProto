...
public class ANS_CapsuleCharacter_Attack_RHandVerticalSlam : ANS_AnimatorState
{
    public readonly ANR_AnimationRange HitBoxActive;

    public ANS_CapsuleCharacter_Attack_RHandVerticalSlam(Animator animator, int animatorLayer)
        : base(animator, nameof(ANS_CapsuleCharacter_Attack_RHandVerticalSlam), animatorLayer, 106)
    {
        HitBoxActive = new(
